...
def build_docx_16_final(output_path, image_path):
    doc = Document()
    ...
    # Sắp xếp lại list để tránh lỗi unpack
    moves = [
        ("① Tướng 5 bình 4!", "............"),
    ...
    for m, n in moves:
        ...
        if m: 
            ...
            if n: add_styled_run(pm, f"\n{n}", italic=True, font_size=10)
        else:
            add_styled_run(pm, n, italic=True, font_size=10)
...
build_docx_16_final(r"D:\Du an dich tan cuc dai toan\output\16\16_full_content_final.docx", image16)
print("DONE_16_FINAL")
